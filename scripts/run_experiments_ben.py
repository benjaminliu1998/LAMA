...
for seed in range(0, 5):
  ...
  for ckpt in ['60', '100', '140', '200', '400', '700', '1000', '1500', '1800', '2000']:
    LMs.append({
                "lm": "bert",
                ...
                "bert_model_dir": "/Volumes/GoogleDrive/My Drive/G2 2021 Fall/AC 297R Capstone/LAMAProbing_Copy/LAMA-main/pre-trained_language_models/bert/multiberts-seed_"+str(seed)+"-step_"+ckpt+"k", # changed from None
                # "bert_model_dir": None
                })
